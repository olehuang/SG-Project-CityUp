...
image_path = r"E:\TUD\Test_Bild\IMG_5040.jpg"
...
if photo_gps is None:
    ...
    result, info = check_photo_location(photo_gps, building_gps, threshold=150)
...
with open(image_path, "rb") as f:
    image_bytes = f.read()
print("_________________________________________________________")
is_clear, var = is_image_blurry(image_bytes, threshold=180)
print("Test is_image_blurry Methode, standard for texture is >= 180")
